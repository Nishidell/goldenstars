    ...
    <section id="products" className="py-20 px-6 w-full bg-[#4A2E1B]">
      <div className="max-w-7xl mx-auto">
          ...
          {products.map((product) => (
            <div key={product.id} className="bg-[#FDF8EE] rounded-2xl overflow-hidden shadow-xl flex flex-col transform hover:-translate-y-2 transition duration-300">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                {/* Updated Bright Yellow Card Button */}
                <button className="w-full py-3 bg-[#FFCC00] text-[#2A1810] font-bold rounded flex items-center justify-center gap-2 hover:bg-[#E6B800] transition">
        ...
        <div className="text-center">
          {/* Updated Bright Yellow View All Button */}
          <Link href="/products" className="inline-flex items-center gap-2 bg-[#FFCC00] text-[#2A1810] px-8 py-3 rounded font-bold hover:bg-[#E6B800] transition shadow-lg">
            View All Products
